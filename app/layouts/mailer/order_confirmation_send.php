                                                ...
                                                <tr>
                                                    <td role="modules-container"
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" align="center"
                                                               ...
                                                               style="padding:30px 0px 30px 0px;" bgcolor="#4d5171">
                                                            <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                                            ...
                                                                                            <img class="max-width"
                                                                                                 ...
                                                                                                 src="https://drive.google.com/file/d/10yLoL8jR1kMEkrX7Or5KSJAmGJKsY69y/preview"
                                                                                                 height="10">
                                                                                        </td>
                                                                                    </tr>
                                                                                    </tbody>
                                                                                        ...
                                                                                        <td style="padding:10px 0px 0px 0px; line-height:16px; text-align:inherit;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #80817f; font-size: 10px">La Nuit des Temps</span>
                                                                                                </div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #80817f; font-size: 10px">8 rue d'hozier</span>
                                                                                                </div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #80817f; font-size: 10px">13002 Marseille</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                                    ...
                                                                    <img class="max-width" border="0"
                                                                         style="display:block; object-fit:cover; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;"
                                                                         width="600" alt=""
                                                                         data-proportionally-constrained="true"
                                                                         data-responsive="false"
                                                                         src="https://i.imgur.com/C1ykp1c.jpg"
                                                                         height="189">
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding:30px 0px 40px 0px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>THANK YOU FOR SHOPPING WITH US TODAY.</strong></span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <br></div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>Sales Receipt</strong></span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <span style="color: #80817f; font-size: 12px">January 20, 2020 5:40 PM&nbsp;</span>
                                                                        </div>
                                                                        <div></div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td style="padding:0px 40px 40px 40px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>Employee:</strong></span><span
                                                                                    style="color: #80817f; font-size: 12px"> Sammie</span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>Customer:</strong></span><span
                                                                                    style="color: #80817f; font-size: 12px"> Jane Doe</span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>Email:</strong></span><span
                                                                                    style="color: #80817f; font-size: 12px"> janedoe@example.com</span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: inherit">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>Ticket Number: </strong></span><span
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #80817f; font-size: 12px"><strong>ITEM</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #80817f; font-size: 12px"><strong>QTY</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                                ...
                                                                                <table class="module" role="module"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: center">
                                                                                                    <span style="color: #80817f; font-size: 12px"><strong>PRICE</strong></span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                <table class="module" role="module"
                                                                                       ...
                                                                                       width="100%"
                                                                                       style="table-layout: fixed;"
                                                                                       data-muid="64573b96-209a-4822-93ec-5c5c732af15c.2.1"
                                                                                       data-mc-module-version="2019-10-22">
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;"
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                <table class="module" role="module"
                                                                                       ...
                                                                                       width="100%"
                                                                                       style="table-layout: fixed;"
                                                                                       data-muid="64573b96-209a-4822-93ec-5c5c732af15c.1.2.1"
                                                                                       data-mc-module-version="2019-10-22">
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;"
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                <table class="module" role="module"
                                                                                       ...
                                                                                       width="100%"
                                                                                       style="table-layout: fixed;"
                                                                                       data-muid="64573b96-209a-4822-93ec-5c5c732af15c.1.1.1.1"
                                                                                       data-mc-module-version="2019-10-22">
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;"
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding:10px 0px 20px 0px; line-height:22px; text-align:inherit;"
                                                                    ...
                                                                    <div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <span style="color: #80817f; font-size: 12px"><strong>Want to check out all our products? We now offer free shipping!&nbsp;</strong></span>
                                                                        </div>
                                                                        <div></div>
                                                                    </div>
                                                                </td>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" bgcolor="#4d5171"
                                                                                ...
                                                                                <a href=""
                                                                                   style="background-color:#4d5171; border:1px solid #4d5171; border-color:#4d5171; border-radius:0px; border-width:1px; color:#dbdbdb; display:inline-block; font-size:12px; font-weight:700; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                                   target="_blank">Shop Online</a>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding:40px 30px 40px 30px; line-height:22px; text-align:inherit; background-color:#80817f;"
                                                                    ...
                                                                    <div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <span style="color: #ffffff; font-size: 12px"><strong>Thank you for shopping at La Nuit des Temps. If you need to return any items, they need to be returned in its original packaging with proof of purchase. If you do not have a proof of purchase, we can offer you store credit.</strong></span>
                                                                        </div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <br></div>
                                                                        <div style="font-family: inherit; text-align: center">
                                                                            <span style="color: #ffffff; font-size: 12px"><strong>We hope you enjoy our products!&nbsp;</strong></span>
                                                                        </div>
                                                                        <div></div>
                                                                    </div>
                                                                </td>
